...
class MT6835_STM32G4 {
public:
    MT6835_STM32G4(int nCS = -1);
    virtual ~MT6835_STM32G4();
	...
	uint16_t getRaw16bitTIM3();

	uint8_t readMT6835_CAL_FREQ();

	uint8_t writeMT6835_CAL_FREQ();

	uint16_t readMT6835_ABZ();

	uint8_t setMT6835_ABZ1();

	uint8_t setMT6835_ABZ2();
